...
void CMenu::RenderWatermark() {
    ...
    snprintf(watermarkText, IM_ARRAYSIZE(watermarkText), "Velocity Linux [%d] | FPS: %d",
             CEngineClient::Get()->GetEngineBuildNumber(), static_cast<int>(ImGui::GetIO().Framerate));
...
void CMenu::RenderMainMenu() {
    ...
    ImGui::Begin("Velocity Linux", nullptr);
    {
